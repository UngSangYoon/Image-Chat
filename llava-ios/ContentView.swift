...
class AppState: ObservableObject {
    ...
    var defaultModels: [LlamaModel] = [
        LlamaModel(
            ...
            url: "https://drive.usercontent.google.com/download?id=1EW9AYA9yuUAFt9WlCD0HqWOsrqXNt8E3&export=download&authuser=0&confirm=t",
            status: "notDownloaded"
        ),
        LlamaModel(
            name: "Model Q8_0",
            filename: "danube-ko-1.8B-base-Q8_0.gguf",
            url: "https://drive.usercontent.google.com/download?id=1mGs10i_bFTyvrVMiacK9yQDw7ugsYfyX&export=download&authuser=0&confirm=t",
            status: "notDownloaded"
        )
    ]
